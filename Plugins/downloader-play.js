...
const handler = async (m, { conn, command, args, text, usedPrefix }) => {
  ...
  let additionalText = '';
  if (['play','شغل', 'طلقلنا', 'play3', 'playdoc'].includes(command)) {
    additionalText = 'audio';
  } else if (['play2' ,'شغل2', 'طلقلنا2',  'play4', 'playdoc2'].includes(command)) {
  ...
  if (['play2', 'شغل2', 'طلقلنا2',  'play4', 'playdoc2'].includes(command)) {
    try {
...
handler.command = /^(play|طلقلنا|شغل|شغل2|طلقلنا2|play2|play3|play4|playdoc|playdoc2)$/i;
